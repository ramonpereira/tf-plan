...
class LQGMultiUnit2DVisualizer():
    ...
    def render(self, step_states, t_states, vx_states_unit1, vx_states_unit2, vy_states_unit1, vy_states_unit2, x_states_unit1, x_states_unit2, y_states_unit1, y_states_unit2):
        ...
        plt.title('LQG 2D Nav Multi Unit (Trajectory)', fontweight='bold')
        plt.grid(True)
        ...
        plt.title('LQG 2D Nav Multi Unit (State Variables)', fontweight='bold')
        plt.legend(loc="best")
